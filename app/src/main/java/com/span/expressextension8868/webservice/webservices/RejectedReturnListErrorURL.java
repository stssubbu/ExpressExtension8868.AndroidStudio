...
public class RejectedReturnListErrorURL extends AsyncTask<String, Void, String> {
    String jsondata;

    Context mContext;

    OnAsyncRejectedError onAsyncResult;
    ...
    public RejectedReturnListErrorURL(String jsstring, Context context) {
        this.jsondata = jsstring;

        this.mContext = context;
    }

    public void setOnResultListener(OnAsyncRejectedError onAsyncResult) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            returnobject = returnListService.getreturnlist(jsondata,
                    ApplicationConfig.GETRETURNSLISTBYBUSINESSID, mContext);
    ...
    public interface OnAsyncRejectedError {
