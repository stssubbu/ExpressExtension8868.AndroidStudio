...
import com.span.expressextension8868.businesslogic.parsing.Timezoneparsing;
...
public class TimezoneService
{
	...
	public Vector<Timezonemodel> gettimezone(String datainput, String URL, Context mContext)
	{
		...
		try
		{
			...
			Timezoneparsing timezoneparsing = new Timezoneparsing();

			returnobject = timezoneparsing.parse(jsonString);
