 ...
 */
public class ReviewErrorListAdapter extends BaseAdapter {
    ...
    public ReviewErrorListAdapter(Context context, Vector<AuditModel> result, int itemLayout, FragmentActivity fA, String BId, String EIN, String BN) {
